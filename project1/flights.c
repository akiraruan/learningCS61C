...
flight_t *createFlight(airport_t *destination, timeHM_t *departure,
 ...
 */
void addFlight(airport_t *source, airport_t *destinintation,
 ...
 *  you might expect to be non-NULL return -1, but test for other possible
 * errors too.
 *
